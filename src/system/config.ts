...
const COSMERE: CosmereRPGConfig = {
    ...
    attributes: {
        [Attribute.Strength]: {
            ...
            label: 'COSMERE.Actor.Attribute.str.long',
            labelShort: 'COSMERE.Actor.Attribute.str.short',
            skills: [Skill.Athletics, Skill.HeavyWeapons],
        },
        [Attribute.Speed]: {
            key: Attribute.Speed,
            label: 'COSMERE.Actor.Attribute.spd.long',
            labelShort: 'COSMERE.Actor.Attribute.spd.short',
            skills: [
                Skill.Agility,
                Skill.LightWeapons,
                Skill.Stealth,
        ...
        [Attribute.Intellect]: {
            ...
            label: 'COSMERE.Actor.Attribute.int.long',
            labelShort: 'COSMERE.Actor.Attribute.int.short',
            skills: [
                Skill.Crafting,
                Skill.Deduction,
                Skill.Lore,
        ...
        [Attribute.Willpower]: {
            ...
            label: 'COSMERE.Actor.Attribute.wil.long',
            labelShort: 'COSMERE.Actor.Attribute.wil.short',
            skills: [Skill.Discipline, Skill.Intimidation],
        },
        [Attribute.Awareness]: {
            key: Attribute.Awareness,
            label: 'COSMERE.Actor.Attribute.awa.long',
            labelShort: 'COSMERE.Actor.Attribute.awa.short',
            skills: [Skill.Insight, Skill.Perception, Skill.Survival],
        },
        [Attribute.Presence]: {
            key: Attribute.Presence,
            label: 'COSMERE.Actor.Attribute.pre.long',
            labelShort: 'COSMERE.Actor.Attribute.pre.short',
    ...
    skills: {
        [Skill.Agility]: {
            key: Skill.Agility,
            label: 'COSMERE.Actor.Skill.agi',
            attribute: Attribute.Speed,
            core: true,
        },
        [Skill.Athletics]: {
            key: Skill.Athletics,
            label: 'COSMERE.Actor.Skill.ath',
            attribute: Attribute.Strength,
            core: true,
        },
        [Skill.HeavyWeapons]: {
            key: Skill.HeavyWeapons,
            label: 'COSMERE.Actor.Skill.hwp',
            attribute: Attribute.Strength,
            core: true,
        },
        [Skill.LightWeapons]: {
            key: Skill.LightWeapons,
            label: 'COSMERE.Actor.Skill.lwp',
            attribute: Attribute.Speed,
            core: true,
        },
        [Skill.Stealth]: {
            key: Skill.Stealth,
            label: 'COSMERE.Actor.Skill.stl',
            attribute: Attribute.Speed,
            core: true,
        },
        [Skill.Thievery]: {
            key: Skill.Thievery,
            label: 'COSMERE.Actor.Skill.thv',
            attribute: Attribute.Speed,
            core: true,
        },
        ...
        [Skill.Crafting]: {
            key: Skill.Crafting,
            label: 'COSMERE.Actor.Skill.cra',
            attribute: Attribute.Intellect,
            core: true,
        },
        [Skill.Deduction]: {
            key: Skill.Deduction,
            label: 'COSMERE.Actor.Skill.ded',
            attribute: Attribute.Intellect,
            core: true,
        },
        [Skill.Discipline]: {
            key: Skill.Discipline,
            label: 'COSMERE.Actor.Skill.dis',
            attribute: Attribute.Willpower,
            core: true,
        },
        [Skill.Intimidation]: {
            key: Skill.Intimidation,
            label: 'COSMERE.Actor.Skill.inm',
            attribute: Attribute.Willpower,
            core: true,
        },
        [Skill.Lore]: {
            key: Skill.Lore,
            label: 'COSMERE.Actor.Skill.lor',
            attribute: Attribute.Intellect,
            core: true,
        },
        [Skill.Medicine]: {
            key: Skill.Medicine,
            label: 'COSMERE.Actor.Skill.med',
            attribute: Attribute.Intellect,
            core: true,
        },
        ...
        [Skill.Deception]: {
            key: Skill.Deception,
            label: 'COSMERE.Actor.Skill.dec',
            attribute: Attribute.Presence,
            core: true,
        },
        [Skill.Insight]: {
            key: Skill.Insight,
            label: 'COSMERE.Actor.Skill.ins',
            attribute: Attribute.Awareness,
            core: true,
        },
        [Skill.Leadership]: {
            key: Skill.Leadership,
            label: 'COSMERE.Actor.Skill.lea',
            attribute: Attribute.Presence,
            core: true,
        },
        [Skill.Perception]: {
            key: Skill.Perception,
            label: 'COSMERE.Actor.Skill.prc',
            attribute: Attribute.Awareness,
            core: true,
        },
        [Skill.Persuasion]: {
            key: Skill.Persuasion,
            label: 'COSMERE.Actor.Skill.prs',
            attribute: Attribute.Presence,
            core: true,
        },
        [Skill.Survival]: {
            key: Skill.Survival,
            label: 'COSMERE.Actor.Skill.sur',
            attribute: Attribute.Awareness,
            core: true,
        },
    },
